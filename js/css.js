let tempCSS = ``
  	...
  	prefixes.forEach(function(prefix, resolucion){
  		...
  		[
  			...
  			tempCSS += `.${value}${prefix}, .${value[0]}${prefix} { text-align : ${value} !important}\n`
  		});
  		
  		tempCSS += `.light${prefix} { font-weight: 300!important}\n`
  		tempCSS += `.bold${prefix} { font-weight: 700!important}\n`
