const DATA = [
 ...
 {
  "id": "e",
  "img": "img/mds-car-controller.webp",
 ...
 {
  "id": "c",
  "img": "img/Documentacion_Moderna.webp",
  "title": "Doc. Moderna",
 ...
 {
  "id": "4",
  "img": "img/Carrera_del_Desierto.jpg",
 ...
 {
  "id": "2",
  "img": "img/Documentacion_Clasica.webp",
  "title": "Doc. Clasica",
 ...
 <article class="col-12 col-sm-6 col-md-4 col-lg-3">
  <div class="card ${item.type.join(' ')}">
    <div class="card-image waves-effect waves-block waves-light">
      <img loading="lazy" class="activator" src="./builds/${item.img}" alt="${item.title}">
    </div>
    ...
    <div class="card-reveal ${item.type.join(' ')}">
      ...
      <p><a class="btn bg-dark float-right b-0" href="./builds/${item.id}.html">Ver más</a></p>
    </div>
  </div>
 </article>
	`
